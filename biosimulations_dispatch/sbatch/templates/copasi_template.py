...
command="SINGULARITYENV_AUTH0_CLIENT_ID=$AUTH0_CLIENT_ID SINGULARITYENV_AUTH0_CLIENT_SECRET=$AUTH0_CLIENT_SECRET SINGULARITYENV_AUTH0_BIOSIMULATIONS_AUDIENCE=$AUTH0_BIOSIMULATIONS_AUDIENCE SINGULARITYENV_AUTH0_TOKEN_URL=$AUTH0_TOKEN_URL SINGULARITYENV_AUTH0_GRANT_TYPE=$AUTH0_GRANT_TYPE SINGULARITYENV_SIMULATION_ID={simulation_id} SINGULARITYENV_USER_SUB_ID={subscriber_id}  SINGULARITYENV_JOB_ID=$SLURM_JOB_UID   SINGULARITYENV_JOBHOOK_URL={jobhook_url} singularity run --bind $TMPDIR:/usr/local/app/copasi/simulation --pwd=/app $localSingularityImage"
echo $command
...
class CopasiTemplate:
    def __init__(self):
        ...
        self.key_list = ['simulation_id', 'temp_dir', 'jobhook_url', 'subscriber_id']
